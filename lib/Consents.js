...
Consent.prototype.parseIntoOAuthServiceRecord = function(){
  console.log("Parsing consent into an OAuth service configuration file....");
  ...
  return {
    ...
    "baseUrl" : "http://acme.org/fhir/baseDstu3",
    "loginUrl" : "https://acme.org/smart/authorize",
    "loginStyle" : "popup",
    "tokenUrl" : "https://acme.org/smart/token"
  };
}
