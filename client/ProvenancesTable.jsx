...
export class ProvenancesTable extends React.Component {
  ...
  getMeteorData() {
    ...
    if(process.env.NODE_ENV === "test") console.log("ProvenancesTable[data]", data);
    return data;
  };
...
ReactMixin(ProvenancesTable.prototype, ReactMeteorData);
